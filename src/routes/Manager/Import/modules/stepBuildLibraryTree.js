...
export const CANCEL_SESSION_TREE_REQUEST = 'CANCEL_SESSION_TREE_REQUEST'
export const CANCEL_SESSION_TREE_SUCCESS = 'CANCEL_SESSION_TREE_SUCCESS'
export const CANCEL_SESSION_TREE_FAILURE = 'CANCEL_SESSION_TREE_FAILURE'
...
// TODO: implement correct cancelation
export function cancelSession (importSessionId) {
  return (dispatch) => {
    dispatch({
      type: IMPORT_CONFIRM_TREE_REQUEST,
      payload: {}
